      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-1.5 text-zinc-400 hover:text-emerald-400 text-sm transition cursor-pointer" onClick={() => showToast("Simulated documentation: Under Construction 🛠️", "info")}>
                <span>API Docs</span>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-500 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="bg-[#111] border border-white/10 px-2 py-0.5 rounded-md text-zinc-300 font-semibold">Spring Boot</span>
            <span>+</span>
            <span className="bg-[#111] border border-white/10 px-2 py-0.5 rounded-md text-zinc-300 font-semibold">React</span>
          </div>
        </div>
