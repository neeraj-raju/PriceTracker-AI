  ...
  return (
    <div className="w-full min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <main className="w-full pt-[56px]">
        ...
        <div className="w-full h-[calc(100vh-56px)] flex flex-col justify-between pb-10 relative overflow-hidden bg-black">
          {/* Seamless Unified Ambient Glows blending Hero and Deals sections */}
